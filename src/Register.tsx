...
function Register() {
    const [name, setNamelog] = useState('');
    const [password, setPwdlog] = useState('');
     ...
     const[login,setLogin]=useState(true)
      ...
      function handleSubmit(e:any ){
        ...
        if(!name || !password){
           ...
           console.log("stoed in local storage ")
           setLogin(!login)
        }
                ...
                <section className='Main-form'>
                    <section className='frame'>
                        ...
                        <section className='Uname'>
                            <input type="text" className='username' placeholder='Username' onChange={(event)=>setNamelog(event.target.value)}  /></section>
                    </section>
                    ...
                    <section className='frame2'>
                        ...
                        <section className='PWD'>
                            <input type="password" placeholder='Password' className='username' onChange={(event)=>setPwdlog(event.target.value)} />
                        </section>
                    </section>
                </section>
